  ...
  const services = [
    {
      ...
      description:
        "Social media is where conversations happen, trends are set, and brands come to life. At Interzens, we create scroll-stopping, share-worthy content that connects with your audience and grows your online presence.",
      details: {
        ...
        seoOptimization: [
          {
            ...
            img: "https://media.githubusercontent.com/media/frontendmakaidigitals/Interzens/refs/heads/main/public/services/SEO.png",
          },
        ],
        topicIdeation:
        ...
        videoProduction: [
          {
            ...
            img: "https://media.githubusercontent.com/media/frontendmakaidigitals/Interzens/refs/heads/main/public/services/video_Production.png",
          },
        ],
        videoFormats: [
          {
        ...
        <div className=" ">
          <div className=" p-7  w-full bg-[#3F51B5] text-slate-100 rounded-xl">
            ...
            <p className="mt-3 font-Synonym font-[400] text-lg">
              ...
              Interzens, where your story meets strategy.
            </p>
            <Link href={"/contact"}>
