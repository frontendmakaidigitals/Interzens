...
const Page = () => {
  ...
  const servicesData = [
    {
      ...
      services: [
        ...
        },
        {
          ...
          img: "https://media.githubusercontent.com/media/frontendmakaidigitals/Interzens/refs/heads/main/public/services/SEO_Audit.png",
        },
        {
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          img: "https://media.githubusercontent.com/media/frontendmakaidigitals/Interzens/refs/heads/main/public/services/google-ad-copywriting-strategies.png",
        },
      ],
    },
  ];
  ...
  const para =
    "Welcome to Interzens - Elevate Your Online Presence Through SEO ";
        ...
        <div className=" ">
          <div className=" p-7  w-full bg-[#3F51B5] text-slate-100 rounded-xl">
            ...
            <p className="mt-3 font-Synonym font-[400] text-lg">
              ...
              with Interzens and watch your business soar. Contact us today for
              a free consultation!
            </p>
            <Link href={"/contact"}>
